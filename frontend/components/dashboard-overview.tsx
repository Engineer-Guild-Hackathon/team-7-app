    ...
    return (
        ...
        <Card>
            ...
            <div className="text-2xl font-bold text-primary">
                {Math.floor(totalStudyTime / 3600)}時間{Math.floor((totalStudyTime / 60) - (totalStudyTime / 3600))}分
            </div>
        ...
        <Card>
            ...
            <div className="text-2xl font-bold">
                ...
                {Math.floor(((totalStudyTime + totalNonStudyTime) / 60) - ((totalStudyTime + totalNonStudyTime) / 3600))}分
            </div>
